def numbers():
    '''
numbers()=checks a file with numbers and finds the smallest of the numbers in it
@param infile=read file containing the numbers
@param numList=list holding numbers from the file
@param smallest=smallest number in the file of numbers
prints the smallest number in the file
    '''
    try:
        ...
        numList.sort()
        smallest=numList[0]
        print(smallest, " is the smallest number in the file.", sep="")
        infile.close()
    except:
